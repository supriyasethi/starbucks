...
public class PinEntryMachine implements IPinStateMachine, IKeyPadObserver, IPinAuthSubject
{
    ...
    /**
     * Change the State to Four Six State
     * @param digit Digit/Number Enterred
     */
    ...
    /**
     * Add Observers for Passcode
     * @param pc Passcode
     */
    public void addObserver(Passcode pc)
    {
        passcode = pc ;
    }

    /**
     * Notify Passcode Observers
     */
    public void notifyPasscodeObserver( )
    {
        if ( passcode != null )
            passcode.getPinCount(pinCount);
    }
    ...
    /**get pinlength to login
     ** @param p String infor
     */
    /** get pin length to login
     * @param p - String to get Pin info
     */
    public void getPinInfo(String p) {
        pin = p ;
        pin4.pinInfo(pin);
    }
}
